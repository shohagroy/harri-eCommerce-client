    ...
    <section className="h-[80vh] bg-[#F0F2EE]">
      <CommonLayout>
        <div className="grid grid-cols-1 lg:grid-cols-2 px-3  gap-4 w-full h-full">
          <div className="flex flex-col z-30 justify-end lg:items-center lg: lg:justify-center leading-none h-full ">
            <div className="">
              ...
              <div className="border w-[150px] lg:mt-10 flex justify-center mt-3 border-black ">
